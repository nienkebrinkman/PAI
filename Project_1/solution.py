...
class Model():
    ...
    def predict(self, test_x):
        ...
        y = self.nystroem_approx_blr.predict(test_x)
        return y
    ...
    def fit_model(self, train_x, train_y):
        """
             TODO: enter your code here
        """
        feature_map_nystroem = Nystroem(kernel=Matern(length_scale=0.7,nu=2.5), random_state=1 )
        self.nystroem_approx_blr = pipeline.Pipeline([("feature_map", feature_map_nystroem),
                                                ("blr",  linear_model.BayesianRidge())])

        self.nystroem_approx_blr.set_params(feature_map__n_components=10)
